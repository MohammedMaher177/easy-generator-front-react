...
import { createRecord, fetchRecords, generateRandomTasks as generateRandomTasksDispatch } from '@/store/slices/todos/slice';
...
export default function Todos({}: Props) {
    ...
    return (
        <div>
            <Header
                BTNs={[{ label: 'Generate Random Tasks', onClick: generateRandomTAsks }]}
                lable="TODO List"
            ...
            {loading ? <Loading /> : <TodosTable data={tableData} />}
